...
VOICE_CONNECT_TIMEOUT_SECONDS: Final[float] = 20.0
VOICE_DISCONNECT_TIMEOUT_SECONDS: Final[float] = 5.0
VOICE_HEALTH_POLL_INTERVAL_SECONDS: Final[float] = 2.0
VOICE_HEALTH_RECOVERY_GRACE_SECONDS: Final[float] = 6.0
VOICE_LISTENER_RECOVERY_GRACE_SECONDS: Final[float] = 3.0
